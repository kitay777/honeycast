...
const form = useForm({
  ...
  mbti: p.value?.mbti ?? "",
  area: p.value?.area ?? "",
  tag_ids: Array.isArray(props.cast?.tag_ids)
    ? [...props.cast.tag_ids]
    : [],
          ...
          <div class="mb-6 p-4 rounded border border-white/20 bg-white/5">
            ...
            <div v-else class="space-y-3">
              ...
              >
                <li>
                  下のボタンから
                  <span class="font-semibold">公式アカウントを友だち追加</span>
                  してください。
                </li>
                <li>
            ...
            <ul class="space-y-2">
              ...
              >
                <div class="text-sm opacity-80">
                  申請者: {{ pmt.viewer.name }} (ID: {{ pmt.viewer.id }})
                </div>
                <div class="text-sm">
                ...
                <div class="flex flex-wrap gap-3">
                  ...
                  >
                    <img
                      ...
                      @load="revokePreviewUrl($event.target.src)"
                    />
                  </div>
                </div>
              </div>
