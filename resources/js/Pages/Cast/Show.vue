    ...
    >
        ...
        <div v-if="gallery.length" class="mt-3 relative">
          <div class="flex gap-3 overflow-x-auto no-scrollbar -mx-2 px-2 py-1">
            ...
            >
              ...
              />
              <div
                v-if="photoShouldBlur(p) && !(p.unblur?.requested)"
              ...
              <div
                v-else-if="photoShouldBlur(p) && p.unblur?.requested"
      ...
      <section class="mx-auto max-w-[780px] mt-8">
        <div class="grid grid-cols-2 gap-2">
          <InfoRow label="ニックネーム" :value="props.cast.nickname || '—'" />
          <InfoRow label="エリア" :value="props.cast.area || '—'" />
          <InfoRow
            label="身長"
            :value="props.cast.height_cm ? props.cast.height_cm + ' cm' : '—'"
          />
          <InfoRow
            label="年齢"
